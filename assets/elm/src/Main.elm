...
import Page.ViewCase as ViewCase
...
type Msg
  ...
  | CaseViewLoaded (Result PageLoadError ViewCase.Model)
  | CaseViewMsg ViewCase.Msg
...
setRoute maybeRoute model =
  ...
  case maybeRoute of
    ...
    Just (Route.CaseView slug) ->
      transition CaseViewLoaded (ViewCase.init slug)
